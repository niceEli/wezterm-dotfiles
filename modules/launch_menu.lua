...
if wezterm.target_triple == "x86_64-pc-windows-msvc" then
	...
	table.insert(launch_menu, {
		...
		args = {
			...
			"-NoExit",
			"-Command",
			'&{Import-Module "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\Common7\\Tools\\Microsoft.VisualStudio.DevShell.dll"; Enter-VsDevShell 87b72232 -SkipAutomaticLocation -DevCmdArguments "-arch=x64 -host_arch=x64"}',
		},
	})
	table.insert(launch_menu, {
	...
	table.insert(launch_menu, {
		...
		args = {
			"cmd.exe",
			"/K",
			"C:\\Users\\niceEli\\scoop\\apps\\miniconda3\\24.9.2-0\\Scripts\\activate.bat",
			"C:\\Users\\niceEli\\scoop\\apps\\miniconda3\\24.9.2-0",
		},
	})
end
